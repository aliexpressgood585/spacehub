          ...
          <div className="text-center space-y-5 py-6">
            ...
            {typeof window !== 'undefined' && !('ontouchstart' in window) && (
              <div className="inline-flex flex-col items-center gap-3 px-5 py-4 rounded-2xl mx-auto"
                ...
                <img
                  src={`https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=${encodeURIComponent('https://www.spacehubapp.com/#tracker')}&bgcolor=020510&color=818cf8&qzone=2`}
